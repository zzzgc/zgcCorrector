...
def compute_sentence_level_prf(results, logger, pro=0.5):
    """
    ...
    logger.info(f'Detection Sentence Level: acc:{acc:.6f}, precision:{precision:.6f}, recall:{recall:.6f}, f1:{f1:.6f}')
